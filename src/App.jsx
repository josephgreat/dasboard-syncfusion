        ...
        <div className="flex relative dark:bg-main-dark-bg">
          <div className="fixed right-4 bottom-4" style={{ zIndex: "1000" }}>
            <TooltipComponent content={"Settings"} position="Top">
              <button
                type="button"
                className="text-3xl p-3 hover:drrop-shadow-xl hover:bg-light-gray text-white"
          ...
          <div className={`dark:bg-main-bg bg-main-bg md:ml-72 w-full ${
            activeMenu ? 'min-h-screen' : 'flex-2'}`}>
